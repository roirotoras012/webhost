...
<html>
        ...
        <div class="col-lg-8 col-md-12 col-sm-12" style="padding-top: 40px;">
            ...
            <hr>
            <form method="post" name="" action="<?php echo base_url().'Establishmentcategory/edit/'.$tbl_estab_cat['estab_cat_id'];?>">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Establishment Category Name</label>
                            <input type="text" name="estab_cat_name" value="<?php echo set_value('estab_cat_name',$tbl_estab_cat['estab_cat_name']);?>" class="form-control">
